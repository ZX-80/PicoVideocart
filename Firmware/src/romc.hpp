...
inline uint8_t romc = ROMC_PIN_MAP(0x1C); // IDLE
...
__always_inline void execute_romc() { 
    switch (romc) {
        case ROMC_PIN_MAP(0x00):
            /*
        ...
        case ROMC_PIN_MAP(0x03):
            ...
            pc0 += 1;
            break;
        case ROMC_PIN_MAP(0x04):
            /*
             * Copy the contents of PC1 into PC0
             */
            pc0 = pc1;
            break;
        case ROMC_PIN_MAP(0x05):
            /*
